    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    <li class="nav-item {{ request()->routeIs(\App\Utils\RouteNames::ACCOUNTING_DASHBOARD) ? 'active' : '' }}">
                        <a class="nav-link" href="{{route(\App\Utils\RouteNames::ACCOUNTING_DASHBOARD)}}">
                    ...
                    <li class="nav-item {{ request()->routeIs(\App\Utils\RouteNames::A_REPORT_CARDS_INDEX) ? 'active' : '' }}">
                        <a class="nav-link" href="{{route(\App\Utils\RouteNames::A_REPORT_CARDS_INDEX)}}">
